...
// workspaceProvider abstracts workspace management, enabling hermetic unit tests
// that never shell out to real git commands.
...
// qualityValidator abstracts quality-gate validation, enabling hermetic unit tests
// that never invoke real test/lint/format tooling.
...
type ClaudeCodeWorker struct {
	...
	gateFactory    func(dir string) qualityValidator // Factory for quality-gate validators
